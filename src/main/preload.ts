...
const bridge: ThreadleafBridge = {
  ...
  runVaultAttachmentNativeAction: (request: VaultAttachmentNativeActionRequest) =>
    ipcRenderer.invoke(
      ipcChannels.vaultAttachmentNativeAction,
      request,
    ) as Promise<VaultAttachmentNativeActionResponse>,
  ...
  relinkAttachment: (
    ...
    ipcRenderer.invoke(
      ...
      expectedVaultId,
      confirmationId,
    ) as Promise<AttachmentRelinkResponse>,
  restoreAttachment: (
    sourceNotePath,
    missingTarget,
    sourceFileName,
    ...
    ipcRenderer.invoke(
      ...
      expectedVaultId,
      confirmationId,
    ) as Promise<AttachmentRestoreResponse>,
  insertAttachment: (
    sourceNotePath,
    targetPath,
    sourceFileName,
  ...
  runPluginEditorPaste: (editorContext, clipboardText) =>
    ipcRenderer.invoke(
