...
export const pluginCompatibilityRegistry = {
      ...
      "platforms": [
        {
          ...
          "status": "verified",
          "limits": [
            "Verified in Linux X11 and Xvfb Electron with the exact upstream and acceptance-vault bundle, a disposable vault, and private state.",
  ...
  "generationId": "8b29ad895b41335af003203b6ec21706acea671e7e890d371582da85da0ac5ea"
} as const;
