...
Threadleaf 0.1.0-beta.2 is a maintainer-led daily-drive beta. Native contributor lanes create
...
```sh
sudo dnf install ./release/Threadleaf-0.1.0-beta.2-linux-x86_64.rpm
