...
observation record for the official Obsidian protocol. Its status is explicitly `unverified`: no
official Obsidian run, screenshots, or Obsidian-generated bytes are present, so no result is
inferred.
