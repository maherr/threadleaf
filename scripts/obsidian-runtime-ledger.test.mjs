...
assert.deepEqual(
  ...
  [
    ...
    ["BasesEntry", "implemented"],
    ["BasesEntryGroup", "implemented"],
    ["BasesQueryResult", "implemented"],
    ["BasesView", "implemented"],
    ["BasesViewConfig", "implemented"],
    ["BooleanValue", "implemented"],
    ["ButtonComponent", "implemented"],
    ["CapacitorAdapter", "unsupported"],
    ...
    ["EditableFileView", "implemented"],
    ["Editor", "implemented"],
    ["editorEditorField", "implemented"],
    ["editorInfoField", "implemented"],
    ["editorLivePreviewField", "implemented"],
    ["EditorSuggest", "implemented"],
    ["editorViewField", "implemented"],
    ["Events", "implemented"],
    ...
    ["HoverPopover", "implemented"],
    ["htmlToMarkdown", "implemented"],
    ["HTMLValue", "implemented"],
    ["IconValue", "implemented"],
    ["ImageValue", "implemented"],
    ...
    ["livePreviewState", "implemented"],
    ["loadMathJax", "unsupported"],
    ["loadMermaid", "unsupported"],
    ["loadPdfJs", "unsupported"],
    ["loadPrism", "unsupported"],
    ...
    ["WorkspaceFloating", "implemented"],
    ["WorkspaceItem", "implemented"],
    ["WorkspaceLeaf", "implemented"],
    ["WorkspaceMobileDrawer", "implemented"],
    ["WorkspaceParent", "implemented"],
    ["WorkspaceRibbon", "implemented"],
...
const syntheticBehaviorClass = {
  name: "SyntheticBehaviorClass",
  kind: "class",
  obligations: [],
};
const syntheticBehaviorBinding = new Map([
  ["SyntheticBehaviorClass", { kind: "class", members: new Set() }],
]);
assert.equal(
  deriveStatus(
    syntheticBehaviorClass,
    {
      implementation: { source: "synthetic.ts", exportName: "SyntheticBehaviorClass" },
      evidence: [{ id: "positive.fixture" }],
      coverage: {
        requiredBehaviorIds: ["constructs-and-observes"],
        behaviors: [{ id: "constructs-and-observes", evidence: [{ id: "positive.fixture" }] }],
      },
    },
    ["SyntheticBehaviorClass"],
    syntheticBehaviorBinding,
    positiveMarkers,
  ),
  "implemented",
  "a zero-member class can be promoted by explicit executable behavior coverage",
);
assert.equal(
  deriveStatus(
    syntheticBehaviorClass,
    {
      ...
      evidence: [{ id: "positive.fixture" }],
      coverage: {
        requiredBehaviorIds: ["constructs-and-observes", "renders"],
        behaviors: [{ id: "constructs-and-observes", evidence: [{ id: "positive.fixture" }] }],
      },
    },
    ["SyntheticBehaviorClass"],
  ...
  "partial",
  "a zero-member class remains partial when a required behavior lacks evidence",
);
assert.equal(
  deriveStatus(
