...
- The compatibility runtime may use public API definitions, open formats, independently written
  ...
  bundled resources.
- Private study of application internals may guide algorithms, data structures, architecture, data
  flow, behavior, and product design. Do not reject an idea because another application uses it. Do
  not reproduce proprietary source code or assets or publish extracted implementation details.
  Source inspection may generate hypotheses, but executable tests prove compatibility claims.
